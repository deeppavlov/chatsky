...
setup(
    name="df_script_viewer",
    version="0.0.1",
    description=description,
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/ruthenian8/dialog_flow_graph_viewer",
    author="Daniil Ignatiev",
    author_email="ruthenian8@google.com",
    ...
    keywords=["chatbots", "df_script_viewer"],  # Optional
