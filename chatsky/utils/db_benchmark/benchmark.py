...
class DBFactory(BaseModel):
    ...
    factory_module: str = "chatsky.context_storages"
    ...
    async def db(self):
        ...
        return await getattr(module, self.factory)(self.uri)
...
class BenchmarkConfig(BaseModel, abc.ABC, frozen=True):
    ...
    :py:class:`~.chatsky.utils.db_benchmark.basic_config.BasicBenchmarkConfig`.
...
class BenchmarkCase(BaseModel):
    ...
    async def run(self):
        ...
        """
        benchmark = asyncio.run(self._run())
...
def save_results_to_file(
    ...
    Files created by this function cen be viewed either by using :py:func:`~chatsky.utils.db_benchmark.report.report` or
