...
VENV_PATH = venv
VERSIONING_FILES =  setup.py makefile docs/source/conf.py df_telegram_connector/__init__.py
...
test: venv
	$(VENV_PATH)/bin/pytest --cov-report html --cov-report term --cov=df_telegram_connector tests/
.PHONY: test
