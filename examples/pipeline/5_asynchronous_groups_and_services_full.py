...
In synchronous service groups services are executed consequently,
            some of them (actor) can even return Context object, modifying it.
...
To become asynchronous service or service group should _be able_ to be asynchronous
...
Generally for optimization purposes asynchronous services
            should be combined into asynchronous groups to run simultaneously.
