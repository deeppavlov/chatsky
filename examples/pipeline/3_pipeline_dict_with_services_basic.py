...
The following example shows pipeline creation from
...
pipeline should be defined as dictionary.
...
def preprocess(_):
    logger.info(
        "another preprocession web-based annotator"
        "Service (defined as a callable)"
    )
