...
# %%
def cannot_talk_about_topic_response(ctx: Context, pl: Pipeline, *args, **kwargs) -> Message:
...
def upper_case_response(response: Message):
    ...
    def func(ctx: Context, pl: Pipeline, *args, **kwargs) -> Message:
...
def fallback_trace_response(ctx: Context, pl: Pipeline, *args, **kwargs) -> Message:
    return Message(
        misc={
