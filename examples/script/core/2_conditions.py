...
# %%
def hi_lower_case_condition(ctx: Context, line: Pipeline, *args, **kwargs) -> bool:
...
def complex_user_answer_condition(ctx: Context, line: Pipeline, *args, **kwargs) -> bool:
    request = ctx.last_request
...
def predetermined_condition(condition: bool):
    ...
    def internal_condition_function(ctx: Context, line: Pipeline, *args, **kwargs) -> bool:
