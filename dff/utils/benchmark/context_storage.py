...
To view files generated by :py:func:`~.save_results_to_file` use either :py:func:`~.report` or
`streamlit app <../../../utils/db_benchmark/benchmark_streamlit.py>`_.
"""
from uuid import uuid4
import pathlib
from time import perf_counter
from typing import Tuple, List, Dict, Union, Set, Literal, Optional, Callable
...
class BenchmarkConfig(BaseModel, frozen=True):
    ...
    def get_context_updater(self) -> Callable[[Context], Optional[Context]]:
        """
        ...
        def _context_updater(context: Context) -> Optional[Context]:
